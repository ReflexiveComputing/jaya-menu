    ...
    >
      <div className="flex items-center">
        ...
        <div className="m-auto w-5/6 flex">
            <h1 className={`w-1/2 text-2xl font-bold font-fajala text-left ${titleHighlighted ? 'text-gray-50' : 'text-gray-950'}`}>
            {title}
           
          </h1>
          {secondaryTitle && (
            <h1 className={`w-1/2 text-2xl pl-2 font-bold font-fajala text-right ${titleHighlighted ? 'text-gray-950' : 'text-gray-50'}`}>
              {secondaryTitle}
            </h1>
          )}  
        </div>
