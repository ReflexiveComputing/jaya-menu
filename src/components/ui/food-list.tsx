    ...
    return (
        <div className="food-item flex flex-col items-start px-2 first:pt-4">
            ...
            <div className="flex w-full justify-start min-h-[60px]">
                <VerticalDashedLines className="mx-3 max-w-0.5 min-h-full" color="#febd3a" dashHeight={4} gap={3} width={2} />
                {favorite.menuItem.shortDescription ? (
                    <p className="w-4/7 px-2 description text-sm text-gray-200">{favorite.menuItem.shortDescription}</p>
